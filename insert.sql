...
-- Insert app_users
INSERT INTO app_user (user_type, user_first_name, user_last_name, user_phone, user_email)
VALUES 
    -- Owners (Company Principals)
    ('Owner', 'Michael', 'Elrod', '230-8694', 'michaelelrod.dev@gmail.com'),
    ...
    ('Client', 'Commercial', 'Properties', '555-0401', 'contact@commercial-prop.com'),
    ('Client', 'Industrial', 'Developers', '555-0402', 'projects@industrial-dev.com'),
    ('Client', 'Retail', 'Centers', '555-0403', 'build@retail-centers.com'),
    ('Client', 'Metropolitan', 'Properties', '555-0404', 'construction@metro-prop.com'),
    ('Client', 'Educational', 'Facilities', '555-0405', 'development@edu-facilities.org'),
    ('Client', 'Healthcare', 'Development', '555-0406', 'facilities@healthcare-dev.com');
